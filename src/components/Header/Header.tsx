      ...
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          <Link aria-label="Cart" className={styles.iconLink} href="/cart">
            <Image alt="Cart" className={styles.icon} height={30} src="/icons/icon_cart.svg" width={30} />
          ...
          <Link aria-label="User profile" className={styles.iconLink} href="/user-profile">
            <Image alt="User profile" className={styles.icon} height={30} src="/icons/icon_user.svg" width={30} />
          </Link>
        </div>
      </div>
    </header>
